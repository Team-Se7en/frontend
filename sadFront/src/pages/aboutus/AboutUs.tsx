      ...
      <Container sx={{ height: "350px" }}>
        <Paper
          ...
          sx={{
            marginTop: "7rem",
            padding: "4rem",
            background: "linear-gradient(45deg, #0F1035 40%, #1e88e5 90%)",
          }}
        >
          <Typography
            variant="h3"
          ...
          <Typography
            sx={{ color: "#fff", fontSize: "30px", fontWeight: "10" }}
          >
            7Apply started its journey in the fall of 2023 with a small team
            developing an educational support system for student. This team
            began with students from Iust University. The team had a big goal
            for students! After a challenging 1-year journey, today 7Apply is
            closer to its goal and has managed to develop products to help the
            growth of students.
          </Typography>
        </Paper>
      </Container>
            ...
            <Card sx={{ padding: "1rem", boxShadow: 3, marginTop: "-5rem" }}>
              <CardContent>
                <Typography
                  ...
                  sx={{ fontWeight: "bold", textAlign: "center" }}
                >
                  7Apply has made the process of communication easier for both
      ...
      >
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} sm={6}>
            <Box>
              <img
                src={AboutUsProfessor}
                alt="University professors"
                style={{ width: "35%" }}
              />
              <Typography
                variant="subtitle1"
      ...
      <Container>
        ...
        <Typography
          sx={{
            ...
            marginBottom: "2rem",
            padding: "1rem",
            background: "linear-gradient(45deg, #0F1035 70%, #1e88e5 90%)",
            borderRadius: "5px",
          }}
        >
          After 1 year since 7Apply started working, today a young, energetic
          and eager team is working hand in hand to expand and empower the
          student community.
        </Typography>
