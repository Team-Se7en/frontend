...
import {
  ...
  StyledCardContent,
  StyledTag,
} from "./ProfessorPositionCard-styles";
    ...
    <>
        ...
        <StyledCardContent className={clsx(globalStyles.flexColumn)}>
          ...
          <Tooltip title={model.university_name}>
            <Box gap={1} className={globalStyles.flexRow} sx={{ mt: 1 }}>
              ...
              <Link
                to={{
                  pathname: "/universitypage/" + props.model.university_id,
                }}
          ...
          >
            <Box gap={1} className={globalStyles.flexRow}>
              ...
              <Typography variant="body1">
                {`${formatTime(model.start_date.toString())} - ${formatTime(
                  model.end_date.toString()
                )}`}
              </Typography>
            </Box>
            <Spacer />
            <Box gap={0.5} className={globalStyles.flexRow}>
              ...
              <Typography variant="body1">
                {`${formatTime(
                  model.position_start_date.toString()
                )} - ${formatTime(model.position_end_date.toString())}`}
              </Typography>
            </Box>
            <Spacer />
            <Box
          ...
          >
            <Box className={globalStyles.flexRow}>
              ...
              <Typography variant="body1">{model.fee}</Typography>
            </Box>

            <Typography variant="body1">Needed: {model.capacity}</Typography>
      ...
      >
        <DeleteDialog
          ...
          onNoClick={handleDeleteDialogClose}
        />
      </Dialog>
    </>
  );
